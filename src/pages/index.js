  ...
  return (
    <Layout pageTitle="Home Page">
      <p>
        ...
        very free form, so I decided to create a simple Gatsby site that showcases a few of the appetizer trays I&aposve
        ...
        interesting, I&aposve added filtering; the user can filter the appetizer trays by ingredients and the type of event
        for which they were made.
      </p>
      <p className='mt-3'>
        Note that this project doesn&post use any special Gatsby plugins related to WordPress. The data is fetched via the
